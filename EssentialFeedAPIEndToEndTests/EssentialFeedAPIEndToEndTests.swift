...
//
//  Created by Abdoulaye Diallo on 6/18/21.
//
...
class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndServerGETFeedResult_matchedFixedTestAccountData(){
        switch getFeedResult() {
            case let .success(imageFeed)?:
                XCTAssertEqual(imageFeed.count, 8, "expected  images in the test feed")
